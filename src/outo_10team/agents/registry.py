...
DEFAULT_TEAM_CONFIGS: list[tuple[str, str, tuple[AgentDef, ...]]] = [
    ...
    (
        "infra",
        "인프라/DevOps - 인프라 관리 및 배포",
        (
            AgentDef("main", "인프라 리더", "당신은 인프라 팀의 리더입니다. 인프라 전략을 수립하고 운영을 관리합니다."),
            AgentDef("cloud", "클우드 엔지니어", "당신은 클라우드 인프라를 관리합니다. AWS, GCP, Azure 환경을 설계합니다."),
